...
public class GameOver4 implements Pantalla {
	...
	private String rutaFondo = "imagenes//gameOver4.png";
	private JFrame ventana;
	private int puntuacion;
	private Sonidos sonido;

	public GameOver4(PanelJuego panelJuego, float tiempo, JFrame ventana, int puntuacion) {
	...
	public void renderizarPantalla(Graphics g) {
		...
		g.drawRect(panelJuego.getWidth() / 3 - 10, panelJuego.getHeight() - 50, 677, 50);
		g.drawString("Pulsa \"Espacio\" para reiniciar el nivel", panelJuego.getWidth() / 3,
				panelJuego.getHeight() - 15);
	}
