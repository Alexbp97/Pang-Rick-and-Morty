...
public class Victoria2 implements Pantalla {
	...
	public Victoria2(PanelJuego panelJuego, float tiempo, JFrame ventana, int puntuacion) {
	...
	public void renderizarPantalla(Graphics g) {
		...
		g.drawString("Parece que no tienes ni un respiro, han", 20, panelJuego.getHeight() - 110);
		g.drawString("llegado los Cromulon a la Tierra y la", 20, panelJuego.getHeight() - 80);
		g.drawString("destruiran a menos que la Tierra les enseñe", 20, panelJuego.getHeight() - 50);
		g.drawString("un buen tema musical, ya sabes que hacer...", 20, panelJuego.getHeight() - 20);
		// Reiniciar
	...
	public void pulsarEspacio() {
		panelJuego.setPantalla(new Nivel3(panelJuego, ventana));
	}
