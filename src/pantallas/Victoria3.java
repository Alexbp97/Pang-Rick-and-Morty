...
public class Victoria3 implements Pantalla {
	...
	public Victoria3(PanelJuego panelJuego, float tiempo, JFrame ventana, int puntuacion) {
	...
	public void renderizarPantalla(Graphics g) {
		...
		g.drawString("Uff por los pelos. Jerry se ha pasado con", 20, panelJuego.getHeight() - 110);
		g.drawString("los mr meeseeks pidiendoles una tarea", 20, panelJuego.getHeight() - 80);
		g.drawString("imposible y ahora hay demasiados, tienes", 20, panelJuego.getHeight() - 50);
		g.drawString("que acabar con ellos como sea.", 20, panelJuego.getHeight() - 20);
		// Reiniciar
	...
	public void pulsarEspacio() {
		panelJuego.setPantalla(new Nivel4(panelJuego, ventana));
	}
